...
import com.igniteplus.data.pipeline.transform.Cleanser.{deDuplication, nullValueCheck, trimFunction}
...
object PipelineService {
  ...
  def pipelineService() = {
    ...
    val nullValueCheckToRemove : DataFrame = nullValueCheck(clickStreamDataDf,PRIMARY_KEY_COLUMNS_CLICKSTREAM_DATA)
    //val nullValueCheckInItemData : DataFrame = nullValueCheck(itemDataDf,PRIMARY_KEY_COLUMNS_ITEM_DATA)
